...
extension AccountEntityMapper on Account {
  AccountsCompanion toCompanion() => AccountsCompanion.insert(
    ...
    currencyCode: Value(currencyCode),
    balanceAtoms: Value(balanceAtoms),
    currencyPrecision: Value(currencyPrecision),
...
extension TransferDataMapper on TransferData {
  Transfer toEntity() => Transfer(
    ...
    sourceAmountAtoms: sourceAmountAtoms,
    sourceAmountScale: sourceAmountScale,
    sourceCurrencyCode: sourceCurrencyCode,
    destinationAmountAtoms: destinationAmountAtoms,
    destinationAmountScale: destinationAmountScale,
    destinationCurrencyCode: destinationCurrencyCode,
    feeAmountAtoms: feeAmountAtoms,
    feeAmountScale: feeAmountScale,
...
extension TransferEntityMapper on Transfer {
  TransfersCompanion toCompanion() => TransfersCompanion.insert(
    ...
    destinationAccountId: destinationAccountId,
    amount: amount,
    sourceAmountAtoms: Value(sourceAmountAtoms),
    sourceAmountScale: Value(sourceAmountScale),
    sourceCurrencyCode: Value(sourceCurrencyCode),
    destinationAmountAtoms: Value(destinationAmountAtoms),
    destinationAmountScale: Value(destinationAmountScale),
    destinationCurrencyCode: Value(destinationCurrencyCode),
    feeAmount: Value<double?>(feeAmount),
    feeAmountAtoms: Value(feeAmountAtoms),
    feeAmountScale: Value(feeAmountScale),
    feeCurrencyCode: Value(feeCurrencyCode),
    note: Value(note),
    occurredAt: occurredAt,
    createdAt: Value(createdAt),
    updatedAt: Value(updatedAt),
...
extension DebtRecordDataMapper on DebtRecordData {
  DebtRecord toEntity() => DebtRecord(
    ...
    amountAtoms: amountAtoms,
    remainingBalanceAtoms: remainingBalanceAtoms,
    amountScale: amountScale,
    currencyCode: currencyCode,
    note: note,
    dueDate: dueDate,
...
extension DebtRecordEntityMapper on DebtRecord {
  DebtRecordsCompanion toCompanion() => DebtRecordsCompanion.insert(
    ...
    remainingBalance: remainingBalance,
    amountAtoms: Value(amountAtoms),
    remainingBalanceAtoms: Value(remainingBalanceAtoms),
    amountScale: Value(amountScale),
    currencyCode: Value(currencyCode),
    note: Value(note),
...
extension GoalDataMapper on GoalData {
  Goal toEntity() => Goal(
    ...
    targetAmountAtoms: targetAmountAtoms,
    currentAmountAtoms: currentAmountAtoms,
    amountScale: amountScale,
    currencyCode: currencyCode,
...
extension GoalEntityMapper on Goal {
  GoalsCompanion toCompanion() => GoalsCompanion.insert(
    ...
    targetAmountAtoms: Value(targetAmountAtoms),
    currentAmountAtoms: Value(currentAmountAtoms),
    amountScale: Value(amountScale),
    currencyCode: Value(currencyCode),
